...
init -1000 python:
    ...
    style_font = 'IBMPlexSansKR-Medium.ttf'
    style_font_monospace = 'IBMPlexSansKR-Medium.ttf'
...
image status_online:
    Text('온라인', style='txt_status')
image status_picture:
    Text('사진 전송', style='txt_status')
image status_audio:
    Text('sends an audio', style='txt_status')
image status_typing:
    Text('타이핑 중.  ', style='txt_status')
    pause 0.2
    Text('타이핑 중.. ', style='txt_status')
    pause 0.2
    Text('타이핑 중...', style='txt_status')
...
image status_offline:
    Text('최근에 접속함', style='txt_status', color='#6d7b85')
