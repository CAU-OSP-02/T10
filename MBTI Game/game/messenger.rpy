...
# screen input_msg():
#     input default "내가 무슨 옷 입고 있더라?" style 'txt_base' align .659, .934 xanchor 0 length 14 color '#fff'
#     $ is_input = True
...
screen messenger():
    ...
    frame background None xysize (400,650) at move_messenger:
        ...
        # input_msg
        # if is_input:
        #     input default "내가 무슨 옷 입고 있더라?" style 'txt_base' length 14 align .12,.99 xanchor 0 color '#fff' action SetVariable(my_msg, value)
